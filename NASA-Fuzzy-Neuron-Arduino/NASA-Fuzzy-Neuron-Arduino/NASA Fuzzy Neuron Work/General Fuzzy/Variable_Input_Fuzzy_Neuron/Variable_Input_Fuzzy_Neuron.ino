...
const double alpha = .000054; // Controls how fast the algorthim learns...largest value we can have without overshooting the cost min
...
void loop() {
  ...
  inputs[0] = random(128); inputs[1] = random(128);
...
void printWeights(int r, double aE) {
